...
class VendingMachine:
    ...
    def add_funds(self, n: int) -> str:
        ...
        elif self.stock == 0 and self.money > 0:
            self.money -= n
    ...
    def vend(self) -> str:
        ...
        """
        "*** YOUR CODE HERE ***"
        if self.stock > 0 and self.money > self.price:
            change = self.money - self.price
            self.stock -= 1
            self.money = 0 
            return f'Here is your {self.product} and ${change} change.'
        elif self.stock > 0 and self.money == self.price:
            self.money = 0
            self.stock -= 1
            ...
            self.money = 0
            return f'Nothing left to vend. Please restock. Here is your ${self.money}.'
        elif self.stock > 0 and self.money < self.price:
